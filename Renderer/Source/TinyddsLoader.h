...
public:
    ...
    static bool TranslateFormat(DDSFile::DXGIFormat fmt, GLFormat* outFormat);
    static bool IsCompressed(GLenum fmt);
    static bool LoadGLTexture(GLuint tex, DDSFile& dds);
};
