...
namespace TinyddsLoader {
    ...
    bool OpenGLDSS::TranslateFormat(DDSFile::DXGIFormat fmt, GLFormat* outFormat) {
    ...
    bool OpenGLDSS::IsCompressed(GLenum fmt) {
        switch (fmt) {
    ...
    bool OpenGLDSS::LoadGLTexture(GLuint tex, DDSFile& dds) {
