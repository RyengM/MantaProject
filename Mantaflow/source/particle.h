...
public:
    ...
    ParticleDataImpl(ParticleBase* particle_system);
...
//TODO: this should be done in processPythonAlias
typedef ParticleDataImpl<int> PdataInt;
typedef ParticleDataImpl<Manta::Vec3> PdataVec3;
typedef ParticleDataImpl<Real> PdataReal;
