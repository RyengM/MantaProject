...
int main()
{
    ...
    do
    {
        std::cout << "Enter grid resolution (between 10 and 500, default 80): ";
        std::cin >> res;
    ...
    if (!fs::exists("simulation data/flip04_adaptDt")) fs::create_directory("simulation data/flip04_adaptDt");
